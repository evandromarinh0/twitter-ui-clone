...
import { Home, Notifications, Email, ExitToApp, FavoriteBorder, Person, Twitter } from '../../styles/Icons';
...
export const Avatar = styled.div`
  ...
  flex-shrink: 0;
  border-radius: 50%;
  background: url('https://pbs.twimg.com/profile_images/1227782522207195136/ePAQ_61B_400x400.jpg') no-repeat;
